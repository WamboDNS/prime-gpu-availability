...
echo "  3. Optional — to also get push notifications on iPhone:"
echo "       a. Install the 'ntfy' app from the App Store."
echo "       b. Pick a long, hard-to-guess topic name (e.g. 'prime-gpu-\$(uuidgen)')."
echo "       c. Write 'https://ntfy.sh/<your-topic>' into ${CONFIG_DIR}/ntfy.url"
echo "       d. In the iOS app, tap '+' and subscribe to the same topic."
echo "  4. Refresh SwiftBar (right-click menu item → Refresh, or run:"
